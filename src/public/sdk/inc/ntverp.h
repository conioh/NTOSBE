...
#define VER_PRODUCTBUILD            /* NT */   4000
...
#define VER_PRODUCTVERSION_W        (0x0505)
#define VER_PRODUCTVERSION_DW       (0x05050000 | VER_PRODUCTBUILD)

/*--------------------------------------------------------------*/
/* this value is used by third party drivers build with the DDK */
/* and internally, to avoid version number conflicts.           */
/*--------------------------------------------------------------*/
#define VER_DDK_PRODUCTVERSION       5,05
#define VER_DDK_PRODUCTVERSION_STR  "5.05"
...
#if 0
// @@END_DDKSPLIT
#define VER_COMPANYNAME_STR         "OpenNT 5.5 DDK provider"
#define VER_PRODUCTNAME_STR         "OpenNT 5.5 DDK driver"
...
#ifdef RC_INVOKED
#define VER_PRODUCTNAME_STR         L"OpenNT Operating System"
#else
